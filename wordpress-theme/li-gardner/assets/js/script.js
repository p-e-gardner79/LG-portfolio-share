...
(function () {
  ...
  function translateGutenbergBlocks(isZh) {
    ...
    // 2. Structural block fallbacks (Target specific block classes directly if saved without data-i18n)
    const blocks = {
      // Tension
    ...
    // Handle multi-span headings like Approach & Fit
